...
import me.thekim123.restapi.common.RestDocsConfiguration;
        ...
        mockMvc.perform(post("/api/events/")
                ...
                .andDo(document("create-event",
                        ...
                        requestFields(
                                ...
                                fieldWithPath("beginEnrollmentDateTime").description("date time of begin of enroll new event"),
                                fieldWithPath("closeEnrollmentDateTime").description("date time of close of enroll new event"),
                                ...
                                fieldWithPath("limitOfEnrollment").description("limit")
                        ),
